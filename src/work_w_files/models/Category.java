...
public class Category extends POJODefault<Integer, String, String, Boolean> implements ICategory {
    ...
    public void inputData(List<Category> categories) {
        ...
        do {
            ...
            if (mName.matches()) {
                ...
                System.err.println("Không trùng nhau, từ 6-30 kí tự");
        } while (true);
        do {
            System.out.print("\nNhập description: ");
    ...
    // remember when using constructor it java will create a instance of class which
    // has instances field is auto initialize
}
